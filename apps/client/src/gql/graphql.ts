...
export type Mutation = {
  ...
  deleteWorkflowCron: Scalars['Boolean']['output'];
  publishWorkflow: Scalars['Boolean']['output'];
  runWorkflow?: Maybe<WorkflowExecution>;
  unpublishWorkflow: Scalars['Boolean']['output'];
  updateWorkflow: Scalars['Boolean']['output'];
  updateWorkflowCron: Scalars['Boolean']['output'];
};
...
export type MutationDeleteWorkflowCronArgs = {
...
export type MutationUnpublishWorkflowArgs = {
  id: Scalars['ID']['input'];
};
...
export type MutationUpdateWorkflowCronArgs = {
...
export type Query = {
  ...
  getCredential?: Maybe<Credential>;
  ...
  getWorkflowExecutions?: Maybe<Array<WorkflowExecution>>;
...
export type QueryGetWorkflowExecutionsArgs = {
  workflowId: Scalars['ID']['input'];
};
...
export type Subscription = {
  ...
  webhookEvent?: Maybe<Scalars['JSON']['output']>;
};


export type SubscriptionWebhookEventArgs = {
  id: Scalars['ID']['input'];
};

export enum TpConnections {
  Discord = 'DISCORD',
...
export type TaskEvent = {
  ...
  outputs?: Maybe<Array<Maybe<Scalars['JSON']['output']>>>;
};

export enum TaskEventEnum {
  CatchHook = 'CATCH_HOOK',
  CatchRawHook = 'CATCH_RAW_HOOK',
  RetrievePool = 'RETRIEVE_POOL'
}
...
export type TaskInfo = {
  ...
  testingAvailable: Scalars['Boolean']['output'];
  type: Scalars['String']['output'];
};
...
export type CreateWorkflowMutation = { __typename?: 'Mutation', createWorkflow?: { __typename?: 'createWorkflowResponse', id: string } | null };
...
export type PublishWorkflowMutation = { __typename?: 'Mutation', publishWorkflow: boolean };

export type UnpublishWorkflowMutationVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type UnpublishWorkflowMutation = { __typename?: 'Mutation', unpublishWorkflow: boolean };

export type UpdateWorkflowCronMutationVariables = Exact<{
  workflowId: Scalars['ID']['input'];
  cron: Scalars['String']['input'];
}>;


export type UpdateWorkflowCronMutation = { __typename?: 'Mutation', updateWorkflowCron: boolean };

export type DeleteWorkflowCronMutationVariables = Exact<{
  workflowId: Scalars['ID']['input'];
}>;


export type DeleteWorkflowCronMutation = { __typename?: 'Mutation', deleteWorkflowCron: boolean };
...
export type GetWorkflowsQuery = { __typename?: 'Query', getWorkflows?: Array<{ __typename?: 'Workflow', id: string, name: string, status: WorkflowStatus, definition?: string | null, description?: string | null, executionPlan?: string | null, createdAt?: any | null, updatedAt?: any | null, creditsCost: number, lastRunAt?: any | null, lastRunId?: string | null, nextRunAt?: any | null, userId?: string | null }> | null };
...
export type GetWorkflowQuery = { __typename?: 'Query', getWorkflow?: { __typename?: 'Workflow', id: string, name: string, status: WorkflowStatus, definition?: string | null, description?: string | null, executionPlan?: string | null, createdAt?: any | null, updatedAt?: any | null, creditsCost: number, cron?: string | null, nextRunAt?: any | null, lastRunAt?: any | null, lastRunId?: string | null, userId?: string | null } | null };

export type GetAvailableTriggersQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAvailableTriggersQuery = { __typename?: 'Query', getAvailableTriggers: Array<{ __typename?: 'AvailableTrigger', id: string, name: string, key: TriggerKey, image?: string | null, taskInfo: { __typename?: 'TaskInfo', label: string, icon?: string | null, type: string, group: TaskGroup, isEntryPoint: boolean, testingAvailable: boolean, requiredConnection: TpConnections, credits: number, events?: Array<{ __typename?: 'TaskEvent', id: string, label: string, description?: string | null, event: TaskEventEnum, inputs?: Array<any | null> | null, outputs?: Array<any | null> | null }> | null, inputs?: Array<{ __typename?: 'TaskParam', type: TaskParamType, options?: Array<string> | null, name: string, required: boolean, variant?: string | null, helperText?: string | null, hideHandle?: boolean | null }> | null, outputs?: Array<{ __typename?: 'TaskParam', type: TaskParamType, name: string, required: boolean, variant?: string | null, helperText?: string | null, hideHandle?: boolean | null }> | null } }> };
...
export type GetAvailableActionsForTriggerQuery = { __typename?: 'Query', getAvailableActionsForTrigger: { __typename?: 'ActionsAndTrigger', actions: Array<{ __typename?: 'AvailableAction', id: string, name: string, key: ActionKey, image?: string | null, taskInfo: { __typename?: 'TaskInfo', label: string, group: TaskGroup, icon?: string | null, type: string, isEntryPoint: boolean, testingAvailable: boolean, requiredConnection: TpConnections, credits: number, events?: Array<{ __typename?: 'TaskEvent', id: string, label: string, description?: string | null, event: TaskEventEnum, inputs?: Array<any | null> | null, outputs?: Array<any | null> | null }> | null, inputs?: Array<{ __typename?: 'TaskParam', type: TaskParamType, options?: Array<string> | null, name: string, required: boolean, variant?: string | null, helperText?: string | null, hideHandle?: boolean | null }> | null, outputs?: Array<{ __typename?: 'TaskParam', type: TaskParamType, name: string, required: boolean, variant?: string | null, helperText?: string | null, hideHandle?: boolean | null }> | null } }>, trigger?: { __typename?: 'AvailableTrigger', id: string, name: string, key: TriggerKey, image?: string | null, taskInfo: { __typename?: 'TaskInfo', label: string, group: TaskGroup, icon?: string | null, type: string, isEntryPoint: boolean, testingAvailable: boolean, requiredConnection: TpConnections, credits: number, events?: Array<{ __typename?: 'TaskEvent', id: string, label: string, description?: string | null, event: TaskEventEnum, outputs?: Array<any | null> | null, inputs?: Array<any | null> | null }> | null, inputs?: Array<{ __typename?: 'TaskParam', type: TaskParamType, name: string, required: boolean, variant?: string | null, options?: Array<string> | null, helperText?: string | null, hideHandle?: boolean | null }> | null, outputs?: Array<{ __typename?: 'TaskParam', type: TaskParamType, name: string, required: boolean, variant?: string | null, helperText?: string | null, hideHandle?: boolean | null }> | null } } | null } };
...
export type GetWorkflowExecutionsQuery = { __typename?: 'Query', getWorkflowExecutions?: Array<{ __typename?: 'WorkflowExecution', id: string, status: WorkflowExecutionStatus, startedAt?: any | null, completedAt?: any | null, trigger: WorkflowExecutionType, creditsConsumed: number }> | null };
...
export type GetCredentialsQuery = { __typename?: 'Query', getCredentials?: Array<{ __typename?: 'Credential', id: string, name: string, value: string }> | null };
...
export type GetCredentialQuery = { __typename?: 'Query', getCredential?: { __typename?: 'Credential', id: string, name: string, value: string } | null };

export type WebhookEventSubscriptionVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type WebhookEventSubscription = { __typename?: 'Subscription', webhookEvent?: any | null };
...
export const PublishWorkflowDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"PublishWorkflow"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"form"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"runWorkflowPayload"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"publishWorkflow"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"form"},"value":{"kind":"Variable","name":{"kind":"Name","value":"form"}}}]}]}}]} as unknown as DocumentNode<PublishWorkflowMutation, PublishWorkflowMutationVariables>;
export const UnpublishWorkflowDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UnpublishWorkflow"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"unpublishWorkflow"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}]}}]} as unknown as DocumentNode<UnpublishWorkflowMutation, UnpublishWorkflowMutationVariables>;
export const UpdateWorkflowCronDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateWorkflowCron"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"workflowId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"cron"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateWorkflowCron"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"workflowId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"workflowId"}}},{"kind":"Argument","name":{"kind":"Name","value":"cron"},"value":{"kind":"Variable","name":{"kind":"Name","value":"cron"}}}]}]}}]} as unknown as DocumentNode<UpdateWorkflowCronMutation, UpdateWorkflowCronMutationVariables>;
export const DeleteWorkflowCronDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteWorkflowCron"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"workflowId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteWorkflowCron"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"workflowId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"workflowId"}}}]}]}}]} as unknown as DocumentNode<DeleteWorkflowCronMutation, DeleteWorkflowCronMutationVariables>;
export const CreateCredentialDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateCredential"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"payload"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"createCredentialPayload"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createCredential"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"payload"},"value":{"kind":"Variable","name":{"kind":"Name","value":"payload"}}}]}]}}]} as unknown as DocumentNode<CreateCredentialMutation, CreateCredentialMutationVariables>;
...
export const WebhookEventDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"WebhookEvent"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"webhookEvent"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}]}}]} as unknown as DocumentNode<WebhookEventSubscription, WebhookEventSubscriptionVariables>;